...
interface SaveGameSectionProps {
  cityId: number;
...
export function SaveGameSection({ cityId, initialFilePath, initialFileName, isOwner }: SaveGameSectionProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Savegame File</h4>
